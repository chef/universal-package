universal-package Omnibus project
=================================
...
```shell
$ bin/omnibus build universal-package
```
...
```shell
$ bin/omnibus clean universal-package
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/universal-package`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean universal-package --purge
```
...
[vagrant@ubuntu...] $ cd universal-package   # or 'cd universal-package/omnibus' if your omnibus project is embedded in your main project
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ bin/omnibus build universal-package
```
